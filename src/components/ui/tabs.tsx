...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-[62px] items-center justify-center rounded-lg bg-topbar p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
