export default function AddImageInput(
  ...
  return (
    <label className="bg-buttonSecondary py-4 pr-5 pl-10 rounded-[104px] font-jakarta font-extrabold text-xs flex items-center gap-[4px] uppercase button-secondary hover:cursor-pointer">
      <svg
        width="13"
        height="13"
        viewBox="0 0 13 13"
